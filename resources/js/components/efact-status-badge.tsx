...
const classes: Record<EFactStatus, string> = {
    pending: 'border-sky-600/40 bg-sky-50 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300',
    processed: 'border-green-600/40 bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-300',
