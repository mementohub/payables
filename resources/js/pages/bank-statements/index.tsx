                ...
                <div className="overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border">
                    <Table aria-label="Lista extrase bancare">
                        <TableCaption className="sr-only">
                            Lista extrase bancare importate, sortate descendent
                            după dată
                        </TableCaption>
                        <TableHeader>
                            <TableRow>
                        ...
                        <TableBody>
                            {statements.data.length === 0 && (
                                <TableRow>
                                    ...
                                    >
                                        Niciun extras bancar. Pornește o
                            ...
                            {statements.data.map((s) => (
                                <TableRow
                                    ...
                                    tabIndex={0}
                                    role="link"
                                    className={`cursor-pointer hover:bg-muted/70 focus-visible:bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none ${s.unallocated_count > 0 ? 'bg-amber-50/50 dark:bg-amber-500/5' : ''}`}
                                >
                                    ...
                                    <TableCell className="hidden text-right text-green-700 tabular-nums sm:table-cell dark:text-green-400">
                                        {formatAmount(
                                            s.total_incoming,
                                            s.moneda,
                                        )}
